...
# The Simple-mode name of "Show on-screen timer"
...
deck-config-steps-too-large-for-algorithm = When { $algorithm } is enabled, steps of 1 day or more are not recommended.
