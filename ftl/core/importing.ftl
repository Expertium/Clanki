...
importing-by-default-anki-will-detect-the = By default, Clanki will detect the character between fields, such as a tab, comma, and so on. If Clanki is detecting the character incorrectly, you can enter it here. Use \t to represent tab.
...
importing-merge-notetypes-help =
    If checked, and you or the deck author altered the schema of a note type, Clanki will
...
importing-field-separator-help =
    ...
    If a file header is not present, Clanki will try to guess what the separator is.
