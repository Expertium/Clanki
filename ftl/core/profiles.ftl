profiles-anki-could-not-read-your-profile = Clanki could not read your profile data. Window sizes and your sync login details have been forgotten.
...
profiles-confirm-lang-choice = Are you sure you wish to display Clanki's interface in { $lang }?
profiles-could-not-create-data-folder = Clanki could not create its data folder. Please see the File Locations section of the manual, and ensure that location is not read-only.
profiles-prefs-corrupt-title = Preferences Corrupt
profiles-prefs-file-is-corrupt = Clanki's prefs21.db file was corrupt and has been recreated. If you were using multiple profiles, please add them back using the same names to recover your cards.
