...
editing-ui-mode-tooltip = Simple keeps the buttons most people use (Preferences > UI split chooses them). The same switch is in the main window, in deck options and in the statistics.
