...
card-templates-anki-couldnt-find-the-line-between = Clanki couldn't find the line between the question and answer. Please adjust the template manually to switch the question and answer.
