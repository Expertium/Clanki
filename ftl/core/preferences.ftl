...
# Preferences > UI split: which parts of the interface Simple mode shows.
preferences-ui-split-tab = UI split
preferences-ui-split-explanation = Choose what Simple mode shows. Advanced mode always shows everything. A hidden menu item keeps its keyboard shortcut, and a hidden setting keeps working.
preferences-ui-split-item = Item
preferences-ui-split-show-in-simple = Show in Simple mode
preferences-ui-split-reset = Reset to defaults
preferences-ui-split-reset-confirm = Show in Simple mode exactly what Clanki shows there by default? Your choices in this tab will be lost.
preferences-ui-split-main-window = Main window
preferences-ui-split-reviewer = Reviewer: More menu
preferences-ui-split-browser = Browser
preferences-ui-split-deck-list = Deck list buttons
preferences-ui-split-deck-menu = Deck menu (the gear next to a deck)
preferences-ui-split-deck-screen = Deck screen buttons
preferences-ui-split-counts = Due counts
preferences-ui-split-learn-count = Learn count, shown on its own (hidden, it is added to Due)
preferences-ui-split-whole-menu = The whole menu
preferences-ui-split-search-bar = Search bar
...
preferences-ui-split-deck-options = Deck options
preferences-ui-split-simple-section = The Simple section
...
preferences-ui-split-rwkv-maintenance = Maintenance: Rebuild RWKV State, Calculate Calibration Graph Data
