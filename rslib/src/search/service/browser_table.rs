...
impl browser_table::Column {
    pub fn to_pb_column(
        ...
        anki_proto::search::browser_columns::Column {
            key: self.to_string(),
            cards_mode_label: self.cards_mode_label(i18n, plain_recall),
            notes_mode_label: self.notes_mode_label(i18n, plain_recall),
            ...
            notes_mode_tooltip: self.notes_mode_tooltip(i18n, plain_recall),
        }
    }
}
